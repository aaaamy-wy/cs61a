...
class VendingMachine:
    ...
    def vend(self):
        if self.quantity == 0:
            ...
            return 'You must deposit $' + str(self.price - self.amount) + ' more.'
        else:
            self.change = self.amount - self.price
            self.amount, self.quantity = 0, self.quantity - 1
            if self.change == 0:
