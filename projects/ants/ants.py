...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while self.attack_place.bees == [] and self.attack_place.entrance != hive and self.range > 0:
            self.attack_place = self.attack_place.entrance
            self.range -= 1
        return random_or_none(self.attack_place.bees)
        # END Problem 3 and 4
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0:
            ...
            copy_bee = bees.copy()
            bees = [bee.reduce_armor(self.damage) for bee in copy_bee]
            self.place.remove_insect(self)
        # END Problem 5
    ...
    def action(self, colony):
        ...
        if self.true_queen == False:
            ...
            while current_place.exit:
                ...
                check_ant = current_place.ant
                if check_ant:
                    if check_ant.is_container and check_ant.contained_ant:
                        double_damage(check_ant.contained_ant)
                    else:
                        double_damage(check_ant)
        # END Problem 13
...
def apply_effect(effect, bee, duration):
    ...
    def affect(colony):
        ...
        if duration > 0:
            ...
            bee.scared, bee.direction = True, True
            old_action(colony)
    bee.action = affect
    # END Problem EC
